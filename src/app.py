...
# Define the language buttons in each column
spanish_button = col1.button(translate("Español"))
english_button = col2.button(translate("Inglés"))
# spanish_button = st.button(translate("Español"))
